 ...
 * @author eliott
 */
public class ChoixAuthentification extends javax.swing.JFrame {

    /**
     * Creates new form ChoixAuthentification
     */
    public ChoixAuthentification() {
        initComponents();
    }
    ...
    private void InscriptionButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InscriptionButtonActionPerformed
        this.dispose(); 
        Inscription jfrm2 = new Inscription();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChoixAuthentification.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChoixAuthentification().setVisible(true);
            }
        });
    }
