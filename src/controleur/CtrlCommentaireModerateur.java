...
import vue.VueCommentaireModerateur;
 ...
 * @author 33652
 */
public class CtrlCommentaireModerateur  extends ControleurGenerique implements ActionListener, WindowListener {
    ...
    public CtrlCommentaireModerateur(CtrlPrincipal ctrlPrincipal) {
        
       
        super(ctrlPrincipal);
       
        
        vue = new VueCommentaireModerateur();
        ...
        getVue().getjButtonDemasquer().addActionListener(this);
    ...
    public VueCommentaireModerateur getVue() {
        return (VueCommentaireModerateur) vue;
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource().equals(getVue().getjButtonDemasquer())){
